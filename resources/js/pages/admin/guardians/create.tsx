...
export default function GuardianCreate({ student }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Data Santri', href: '/admin/students' },
        { title: student.full_name, href: `/admin/students/${student.id}` },
        { title: 'Tambah Wali', href: `/admin/students/${student.id}/guardians/create` },
    ];
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(`/admin/students/${student.id}/guardians`);
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Wali Santri" />
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <Heading title="Tambah Wali Santri" description={`Wali dari ${student.full_name} (${student.nis})`} />
